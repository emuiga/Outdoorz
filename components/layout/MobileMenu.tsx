      ...
      {isOpen && (
        <>
          ...
          <motion.nav
            ...
            className="fixed top-0 right-0 z-50 flex h-full w-4/5 max-w-sm flex-col bg-moss"
          ...
          >
            <div className="flex items-center justify-between px-6 py-5 border-b border-white/10">
              ...
              <button
                ...
                className="text-mist/70 hover:text-malachite transition-colors p-1"
              >
                <X size={22} />
              </button>
            </div>
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <li key={link.href}>
                    ...
                    >
                      {isActive && (
                        <span className="h-1.5 w-1.5 rounded-full bg-malachite flex-shrink-0" />
                      )}
                      {link.label}
                    </Link>
                  </li>
